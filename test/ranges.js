...
describe("Range", function() {
  ...
  return describe(".some", function() {
    return it("behaves as Array.some()", function() {
      expect(new Liquid.Range(0, 4).some(function(v) {
        return v === 2;
      })).to.be.ok;

      expect(new Liquid.Range(4, 0).some(function(v) {
        return v === 2;
      })).to.be.ok;
      ...
      return expect(new Liquid.Range(4, 0).some(function(v) {
        return v === 10;
      })).to.not.be.ok;
    });
  });
